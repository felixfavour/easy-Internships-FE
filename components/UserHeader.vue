  ...
  <div class="profile-header-ctn">
    <div class="profile-header">
      ...
      <div class="profile-info">
        ...
        <div class="actions">
          <nuxt-link v-if="!interested" to="#" class="primary-btn" @click.native="addInterest">
            <Loader v-if="$store.state.loading" class="icon" /> <span class="icon">+</span> I'm Interested
          </nuxt-link>
          <nuxt-link v-if="interested" to="#" class="primary-btn" @click.native="addInterest">
            <Loader v-if="$store.state.loading" class="icon" /> <IconCheck class="icon" /> Added
          </nuxt-link>
        </div>
      </div>
    </div>
